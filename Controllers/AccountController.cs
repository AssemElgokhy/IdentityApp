    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await _sendGridEmail.SendEmailAsync(model.Email, "Reset Email Confirmation", "Please reset email by gpoing thorugh this" + "<a href=\"" +
                    callbackurl + "\">link</a>");
        ...
        public async Task<IActionResult> Register(RegisterViewModel registerViewModel, string? returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                ModelState.AddModelError("Password", "User could not be created, Password is not strong enough ");
